...
for iSide = 1:2
    for iSubject = 1:26            
        sensDelta{dataset}((iSide-1)*26+iSubject) = (mean(d_val(iSubject,(iSide-1)*3+iSess,:))+mean(d_inv(iSubject,(iSide-1)*3+iSess,:)))/2;
        cc_biasDelta{dataset}((iSide-1)*26+iSubject) = (cc_val(iSubject,(iSide-1)*3+iSess)+cc_inv(iSubject,(iSide-1)*3+iSess))/2;
...
for iSubject = 1:28
    sensDelta{dataset}(iSubject) = (mean(d_val(iSubject,iSess,:))+mean(d_inv(iSubject,iSess,:)))/2;
    cc_biasDelta{dataset}(iSubject) = (cc_val(iSubject,iSess)+cc_inv(iSubject,iSess))/2;
...
title(sess(iSess)+": avg-sens vs corr-valid, "+newline+"r = " + num2str(round(corr_sensDelta_valid.r,3))+", p = " + num2str(round(corr_sensDelta_valid.p,3)));
xlim(xlim_val_d); 
ylim(ylim_val);
...
title(sess(iSess)+": avg-sens vs corr-invalid, "+newline+"r = " + num2str(round(corr_sensDelta_invalid.r,3))+", p = " + num2str(round(corr_sensDelta_invalid.p,3)));
xlim(xlim_val_d); 
ylim(ylim_val);
xlabel("sens"); ylabel("DBM 'r' ");
...
title(sess(iSess)+": avg-sens vs corr-nochange, "+newline+"r = " + num2str(round(corr_sensDelta_nochange.r,3))+", p = " + num2str(round(corr_sensDelta_nochange.p,3)));
xlim(xlim_val_d); 
ylim(ylim_val);
xlabel("sens"); ylabel("DBM 'r' ");    
...
title(sess(iSess)+": avg-sens vs corr-cue, "+newline+"r = " + num2str(round(corr_sensDelta_cue.r,3))+", p = " + num2str(round(corr_sensDelta_cue.p,3)));
xlim(xlim_val_d); 
ylim(ylim_val);
xlabel("sens"); ylabel("DBM 'r' ");
...
saveas(gcf,plot_savepath+type+"_avg-sens_rt.png")    
...
title(sess(iSess)+": avg-CC bias vs corr-valid, "+newline+"r = " + num2str(round(corr_cc_biasDelta_valid.r,3))+", p = " + num2str(round(corr_cc_biasDelta_valid.p,3)));
xlim(xlim_val_cc); 
ylim(ylim_val);
...
title(sess(iSess)+": avg-CC bias vs corr-invalid, "+newline+"r = " + num2str(round(corr_cc_biasDelta_invalid.r,3))+", p = " + num2str(round(corr_cc_biasDelta_invalid.p,3)));
xlim(xlim_val_cc); 
ylim(ylim_val);
xlabel("bias"); ylabel("DBM 'r' ");
...
title(sess(iSess)+": avg-CC bias vs corr-nochange, "+newline+"r = " + num2str(round(corr_cc_biasDelta_nochange.r,3))+", p = " + num2str(round(corr_cc_biasDelta_nochange.p,3)));
xlim(xlim_val_cc); 
ylim(ylim_val);
xlabel("bias"); ylabel("DBM 'r' ");
...
title(sess(iSess)+": avg-CC bias vs corr-cue, "+newline+"r = " + num2str(round(corr_cc_biasDelta_cue.r,3))+", p = " + num2str(round(corr_cc_biasDelta_cue.p,3)));
xlim(xlim_val_cc); 
ylim(ylim_val);
xlabel("bias"); ylabel("DBM 'r' ");
...
set(gcf,'position',[50,50,1800,400])
%linkaxes([ax1 ax2 ax3 ax4],'xy')
saveas(gcf,plot_savepath+type+"_avg-cc_bias_rt.png")
